...
def openfile(file: str, mask: str=None, resized: bool=False, block: bool=False, array: bool=False) -> None:
...
def openarray(array: type(np.ndarray), mask: type(np.ndarray)=None, resized: bool=False, block: bool=False) -> None:
    import numpy as np
    import tempfile
